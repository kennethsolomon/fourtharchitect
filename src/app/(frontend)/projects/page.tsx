  ...
  const projects = [
    {
      ...
      area: "450 sqm",
      description: "A contemporary tropical villa that maximizes natural ventilation and showcases stunning bay views through large glass openings.",
      images: [
    ...
    },
    {
      ...
      type: "Vacation Home",
      area: "320 sqm",
      description: "A sustainable beach house designed to withstand coastal conditions while providing a seamless indoor-outdoor living experience.",
      images: [
    ...
    },
    {
      ...
      area: "280 sqm",
      description: "A minimalist concrete residence that creates private courtyards and maximizes natural light in an urban setting.",
      images: [
    ...
    },
    {
      ...
      area: "180 sqm",
      description: "A series of compact townhouses that demonstrate tropical adaptation in dense urban environments.",
      images: [
    ...
    },
    {
      ...
      area: "800 sqm",
      description: "A multi-purpose community center designed to serve as a cultural hub with flexible spaces for various activities.",
      images: [
    ...
    },
    {
      ...
      type: "Hospitality",
      area: "1200 sqm",
      description: "An eco-friendly resort pavilion that integrates renewable energy systems and local materials.",
      images: [
        "https://architropics.com/wp-content/uploads/2020/06/YNE-House_02.jpg"
      ],
      awards: []
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">
              A showcase of our architectural excellence across the Philippines,
              demonstrating innovation in tropical design and sustainable building practices.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project, index) => (
              <Link key={project.id} href={`/projects/${project.slug}`} className="group cursor-pointer hover-scale">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                ...
                incorporating passive cooling strategies and sustainable materials to create
                a comfortable living environment that responds to the Philippine climate.
              </p>
              ...
              <Link href={`/projects/${projects[0].slug}`} className="inline-flex items-center text-black hover:text-fourth-yellow transition-colors group">
      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/services" className="border border-gray-300 text-gray-700 px-8 py-3 rounded font-semibold hover:border-fourth-yellow hover:text-fourth-yellow transition-colors">
              Our Services
            </Link>
          </div>
        </div>
