        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to bring your architectural vision to life? Let's start the conversation about your next project.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-green-800">Thank you for your inquiry! We'll get back to you within 24 hours.</p>
                </div>
              )}

              {submitStatus === 'error' && (
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-red-800">There was an error submitting your form. Please try again or contact us directly.</p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-fourth-yellow text-black py-4 px-8 rounded-lg font-semibold hover:bg-yellow-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div>
              ...
              <div className="space-y-8 mb-12">
                <div>
                  ...
                  <p className="text-gray-600">
                    Fourth Architects Studio<br />
                    123 Rizal Street, City Center<br />
                    Sorsogon City, Sorsogon 4700<br />
                    Philippines
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-fourth-yellow mb-3">Contact Information</h3>
                  <div className="space-y-2">
                    <p className="text-gray-600">
                      <strong>Phone:</strong> <a href="tel:+639123456789" className="hover:text-fourth-yellow transition-colors">+63 912 345 6789</a>
                    </p>
                    <p className="text-gray-600">
                      <strong>Email:</strong> <a href="mailto:office@fourtharchitects.com" className="hover:text-fourth-yellow transition-colors">office@fourtharchitects.com</a>
                    </p>
                    <p className="text-gray-600">
                      <strong>Projects:</strong> <a href="mailto:projects@fourtharchitects.com" className="hover:text-fourth-yellow transition-colors">projects@fourtharchitects.com</a>
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/MArkitekturaph" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-fourth-yellow transition-colors">
                      Facebook
                    </a>
                    <a href="#" className="text-gray-600 hover:text-fourth-yellow transition-colors">
                      Instagram
                    </a>
                    <a href="#" className="text-gray-600 hover:text-fourth-yellow transition-colors">
                      LinkedIn
              ...
              <div className="grid gap-4">
                <div className="border border-gray-200 rounded-lg p-6 hover:border-fourth-yellow transition-colors">
                  ...
                  <p className="text-gray-600 text-sm mb-3">Ready to start your architectural journey?</p>
                  <a href="mailto:projects@fourtharchitects.com" className="text-fourth-yellow hover:underline text-sm font-semibold">
                ...
                <div className="border border-gray-200 rounded-lg p-6 hover:border-fourth-yellow transition-colors">
                  ...
                  <a href="mailto:office@fourtharchitects.com" className="text-fourth-yellow hover:underline text-sm font-semibold">
      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Located in the heart of Sorsogon City, our studio is open for consultations and project discussions.</p>
          </div>
            ...
            <div className="p-6 border-t">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">123 Rizal Street, City Center<br />Sorsogon City, Sorsogon 4700</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Parking</h4>
                  <p className="text-gray-600 text-sm">Free client parking available<br />Entrance on Rizal Street</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Public Transport</h4>
                  <p className="text-gray-600 text-sm">Accessible by jeepney and tricycle<br />Near public market</p>
                </div>
              </div>
            </div>
          </div>
