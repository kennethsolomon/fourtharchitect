  ...
  const timeline = [
    {
      ...
      title: 'Foundation',
      description:
        'Fourth Architects was founded in Sorsogon City with a vision to create exceptional tropical architecture.',
    },
    {
      year: '2008',
      title: 'First Major Project',
      description:
        'Completed our first large-scale residential development, establishing our reputation for quality design.',
    },
    {
      year: '2012',
      title: 'Sustainable Focus',
      description:
        'Integrated sustainable design principles into all projects, becoming pioneers in green architecture in the region.',
    },
    {
      year: '2016',
      title: 'Regional Expansion',
      description:
        'Extended our services across the Bicol region, completing projects in multiple provinces.',
    },
    {
      year: '2020',
      title: 'Digital Innovation',
      description:
        'Adopted advanced 3D modeling and virtual reality technologies to enhance client experience.',
    },
    {
      year: '2024',
      title: 'Today',
      description:
        'Continuing to push boundaries in tropical architecture with 50+ completed projects and numerous awards.',
    },
  ]
  ...
  const values = [
    {
      title: 'Innovation',
      description:
        'We continuously explore new design solutions and technologies to create cutting-edge architecture.',
      icon: '💡',
    },
    {
    ...
    },
    {
      title: 'Quality',
      description:
        'We maintain the highest standards of design excellence and construction quality.',
      icon: '⭐',
    },
  ]
    ...
    <div className="min-h-screen bg-white text-black">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-display mb-6">
              FOURTH <span className="text-yellow-400">STUDIO</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Innovative architects and builders from Sorsogon, creating exceptional tropical
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-gray-600">
                <p>
                  Fourth Architects was born from a passion for creating architecture that truly
                  belongs to the Philippines. Founded in 2003 in the beautiful province of Sorsogon,
                  we began with a simple yet ambitious vision: to design buildings that celebrate
                  our tropical climate while meeting the evolving needs of modern Filipino families.
                </p>
                <p>
                  Over two decades, we have grown from a small local practice to a respected
                  regional firm, completing over 50 projects across the Bicol region and beyond. Our
                  work spans residential homes, commercial buildings, and public spaces, each
                  designed with careful attention to environmental sustainability and cultural
                  context.
                </p>
                <p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-yellow-400"></div>
            <div className="space-y-12">
              <div className="flex items-center ">
                <div className="w-1/2 pr-8 text-right">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <div className="text-2xl font-bold text-yellow-400 mb-2">2003</div>
                    <h3 className="text-xl font-semibold mb-3">Foundation</h3>
                    <p className="text-gray-600">
                      Fourth Architects was founded in Sorsogon City with a vision to create
                      exceptional tropical architecture.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center flex-row-reverse">
                <div className="w-1/2 pl-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    ...
                    <h3 className="text-xl font-semibold mb-3">First Major Project</h3>
                    <p className="text-gray-600">
                      Completed our first large-scale residential development, establishing our
              ...
              <div className="flex items-center ">
                <div className="w-1/2 pr-8 text-right">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <div className="text-2xl font-bold text-yellow-400 mb-2">2012</div>
                    <h3 className="text-xl font-semibold mb-3">Sustainable Focus</h3>
                    <p className="text-gray-600">
                      Integrated sustainable design principles into all projects, becoming pioneers
                      in green architecture in the region.
                    </p>
                  </div>
                </div>
                <div className="relative z-10">
              ...
              <div className="flex items-center flex-row-reverse">
                <div className="w-1/2 pl-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <div className="text-2xl font-bold text-yellow-400 mb-2">2016</div>
                    <h3 className="text-xl font-semibold mb-3">Regional Expansion</h3>
                    <p className="text-gray-600">
                      Extended our services across the Bicol region, completing projects in multiple
                      provinces.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center ">
                <div className="w-1/2 pr-8 text-right">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <div className="text-2xl font-bold text-yellow-400 mb-2">2020</div>
                    <h3 className="text-xl font-semibold mb-3">Digital Innovation</h3>
                    <p className="text-gray-600">
                      Adopted advanced 3D modeling and virtual reality technologies to enhance
                      client experience.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center flex-row-reverse">
                <div className="w-1/2 pl-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <div className="text-2xl font-bold text-yellow-400 mb-2">2024</div>
                    <h3 className="text-xl font-semibold mb-3">Today</h3>
                    <p className="text-gray-600">
                      Continuing to push boundaries in tropical architecture with 50+ completed
                      projects and numerous awards.
                    </p>
                  </div>
                </div>
                <div className="relative z-10">
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-600">
                ...
                <p>
                  ...
                  characteristics of the Philippine archipelago. Our design philosophy centers on
                  creating buildings that breathe with the tropical climate, celebrate natural
                ...
                <p>
                  Through thoughtful integration of passive design strategies, local craftsmanship,
                  and contemporary technology, we create architecture that is both timeless and
                  thoroughly modern.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-yellow-400 text-black px-8 py-3 rounded font-semibold hover:bg-yellow-400 transition-colors"
            >
              Start a Conversation
            </Link>
            <Link
              href="/projects"
              className="border border-gray-300 text-gray-700 px-8 py-3 rounded font-semibold hover:border-yellow-400 hover:text-yellow-400 transition-colors"
            >
              View Our Work
            </Link>
          </div>
